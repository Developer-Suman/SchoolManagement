                ...
                var modules = new List<Modules>()
                 {
                            ...
                            new Modules("0bbf93db-2989-429e-b278-09b41be5bb4b", "Finance","School", "4", "-", "/finance", true),
                            new Modules("0d4c0151-3f88-4bf9-addd-8d14be921ec8", "Dashboard","School", "1", "Home", "/dashboard", true),
                            new Modules("2516bbdd-23e7-4945-9555-be4d85676877", "Miscellaneous","School","7", "-", "/miscellaneous", false),
                            new Modules("25bc79d7-33ea-42e3-a3d1-70dfe9868ab3", "Report","School", "8", "-", "/report", true),
                            new Modules("2d173ac3-bcfc-4626-8888-370bd6207e33", "Academics", "School" ,"3","-", "/academic", false),
                            new Modules("3a742199-322c-44c1-895d-e1e89ced978d", "Students", "School" ,"1", "-", "/student", false),
                            new Modules("3dcab2aa-18b3-4202-b72f-76960965f8ed", "Notice","School" , "1", "-", null, true),
                            new Modules("608887a2-54d2-444f-9828-20280883e177", "Applications","Crm" , "2", "/Factory", "/applications", false),
                            new Modules("6647a855-629b-4289-abb0-d5d20b107216", "Services","Crm" , "4", "abc", "/services", true),
                            new Modules("6a6c5b5f-8445-4709-8a9a-26a67626ba62", "Staff Management","School" , "9", "-", "/staff", true),
                            new Modules("8192a5a9-6fee-4c79-aeaa-4a217b03eca9", "Dashboard", "1","Crm" , "Home", "/crm/dashboard", true),
                            new Modules("8c834e6b-2510-48ee-b255-4994ffa49197", "User","", "2", "-", "/User", true),
                            new Modules("957aa29b-3d6f-4eec-be8f-d5bf71b29495", "Academic Program","Crm" , "2", "-", "/academicProgram", false),
                            ...
                            new Modules("b90bf690-d70f-46ba-a36e-7db6acd4d4f0", "Attendance Management","School" , "5", "-", "/attendance", true),
                            new Modules("b9d4dfc3-3094-4db0-b25e-63b841b66664", "Exam and Grading","School" , "6", "-", "/exam", false),
                            new Modules("c76639f5-189e-4361-b917-c59ddedc4832", "Services","Crm" , "3", "abc", "/services", false),
                            new Modules("e02e4bbd-e3ef-46c5-a7ee-60772dc8db87", "Class Management","Crm" , "7", "-", "/class", false),
                            new Modules("e26231b3-d434-44f3-a58c-3a62d9a8a4b6", "Certificate","School" , "10", "-", "/certificate", true)
