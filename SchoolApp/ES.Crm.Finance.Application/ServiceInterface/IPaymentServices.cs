...
namespace ES.Crm.Finance.Application.ServiceInterface
{
    public interface IPaymentServices
    {
        ...
        Task HandleInstallmentPayment(Invoice invoice, CrmPayment payment, CancellationToken cancellationToken = default);
        Task HandleInstantPayment(Invoice invoice, CrmPayment payment, CancellationToken cancellationToken = default);
        ...
        Task<Result<PagedResult<FilterInstallmentPaymentsResponse>>> FilterInstallmentPayment(PaginationRequest paginationRequest, FilterInstallmentPaymentsDTOs filterInstallmentPaymentsDTOs);
    }
}
