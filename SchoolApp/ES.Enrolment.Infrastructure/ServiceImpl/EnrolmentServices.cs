            ...
            using (var scope = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
            {
                try
                {
                    ...
                    var add = new CrmLead(
                        ...
                        addInquiryCommand.englishProficiency,
                        addInquiryCommand.bandScore,
                        addInquiryCommand.languageRemarks,
                        addInquiryCommand.skillOrTrainingName,
                        addInquiryCommand.institutionName,
                        addInquiryCommand.trainingRemarks,
                        addInquiryCommand.trainingStartDate,
                        addInquiryCommand.trainingEndDate,
            ...
            try
            {
                ...
                var response = new InqueryByIdResponse(
                   ...
                   crmLead.Profile?.EnrolmentType ?? default,
                    ...
                    crmLead.EnglishProficiency,
                    crmLead.BandScore,
                    crmLead.LanguageRemarks,
                    crmLead.SkillOrTrainingName,
                    crmLead.InstitutionName,
                    crmLead.TrainingRemarks,
                    crmLead.TrainingStartDate,
                    crmLead.TrainingEndDate,
