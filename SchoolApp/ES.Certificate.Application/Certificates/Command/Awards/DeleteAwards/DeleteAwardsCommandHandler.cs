...
namespace ES.Certificate.Application.Certificates.Command.Awards.DeleteAwards
{
    public class DeleteAwardsCommandHandler : IRequestHandler<DeleteAwardsCommand, Result<bool>>
    {
        ...
        public DeleteAwardsCommandHandler(IMapper mapper, IAwardsServices awardsServices)
        {
