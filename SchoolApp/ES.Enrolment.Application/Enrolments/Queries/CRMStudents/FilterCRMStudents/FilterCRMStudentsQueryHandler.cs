...
namespace ES.Enrolment.Application.Enrolments.Queries.CRMStudents.FilterCRMStudents
{
    public class FilterCRMStudentsQueryHandler : IRequestHandler<FilterCRMStudentsQuery, Result<PagedResult<FilterCRMStudentsResponse>>>
    {
        ...
        {
            var entityName = typeof(FilterCRMStudentsQuery).Name
                   .Replace("Filter", "")
                   .Replace("Query", "");
            try
            {
                ...
                return Result<PagedResult<FilterCRMStudentsResponse>>.Success(resultDisplay, $"{entityName} return Successfully");
            }
            catch (Exception ex)
            {
